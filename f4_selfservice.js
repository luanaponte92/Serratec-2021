...
que o prato vazio pesa 465 gramas (tara). A etiqueta irá conter o nome do
restaurante, a tara do prato, o preço de 100 gramas, o peso consumido e o
valor total.*/

const ler = require("prompt-sync")();

var nomeRestaurante= "Restaurante Self-Sevice";
var tara= 465;
var precoPorGrama= 3.99;
var pesoPrato=  ler("Qual é o peso do prato em gramas? ");
...
console.log(" A cada 100 gramas será cobrado o valor R$", precoPorGrama);
